...
export class AddPropertyComponent implements OnInit {
  ...
  //@ViewChild(NgForm) addPropertyForm: NgForm | undefined ;
  @ViewChild('formTabs') formTabs!: TabsetComponent;

  addPropertyForm: FormGroup = null as any;
  ...
  Yn: Array<string> = ['Yes', 'No'];
  Way: Array<string> = ['Easr', 'West', 'South', 'North']
  ...
  onSubmit(): void{
    ...
    if(this.allTabsValid()){
      ...
      this.alertify.error("Please review the form and provide all valid entrie");
    }
  }
